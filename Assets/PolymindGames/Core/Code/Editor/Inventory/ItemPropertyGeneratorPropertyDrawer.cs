...
namespace PolymindGamesEditor.InventorySystem
{
    ...
    {
        private readonly DataReferenceDrawer _propertyReferenceDrawer =
            new(typeof(ItemPropertyDefinition), new DataReferenceDetailsAttribute
            {
                HasNullElement = true,
                NullElementName = "Empty"
            });

        private DataReferenceDrawer _itemReferenceDrawer;
        ...
        {
            _itemReferenceDrawer ??= new DataReferenceDrawer(typeof(ItemDefinition),
                new DataReferenceDetailsAttribute
                {
                    HasNullElement = true,
                    NullElementName = "Empty"
                });
