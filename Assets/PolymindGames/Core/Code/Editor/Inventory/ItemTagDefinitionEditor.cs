...
namespace PolymindGamesEditor.InventorySystem
{
    ...
    public sealed class ItemTagDefinitionEditor : DataDefinitionEditor<ItemTagDefinition>
    {
        ...
        {
            var tag = (ItemTagDefinition)target;
            _itemReferences ??= ItemDefinition.GetAllItemsWithTag(tag);
