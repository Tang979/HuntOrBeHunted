...
namespace PolymindGamesEditor
{
    ...
    public sealed class MaterialConversionSettings : ScriptableObject
    {
        ...
        private sealed class ShaderInfo
        {
            ...
            [FormerlySerializedAs("TextureProperties")]
            [FormerlySerializedAs("TextureShaderProperties")]
            [ReorderableList(ListStyle.Lined), IgnoreParent]
        ...
        [SerializeField, ReorderableList(ListStyle.Boxed, ElementLabel = "Conversion Info")]
        ...
        public Dictionary<Shader, MaterialConversionInfo> GetDictionary()
        {
