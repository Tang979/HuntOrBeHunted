...
namespace PolymindGames
{
    ...
    public sealed class AudioManager : Manager<AudioManager>
    {
        ...
        [SerializeField, BeginGroup("Groups")]
        ...
        [SerializeField, Range(1, 50), BeginGroup("Audio Sources")]
        ...
        public const int NULL_LOOP_ID = -1;
        ...
        public void PlayClipAtPositionDelayed(AudioClip clip, Vector3 position, float delay, float volume = 1f, float pitch = 1f)
        {
            var source = GetNext3DAudioSource();
            source.transform.position = position;
        ...
        public void PlayClip2DDelayed(AudioClip clip, float delay, float volume = 1f, float pitch = 1f)
        {
            var source = GetNext2DAudioSource();
        ...
        public void PlayUIClipDelayed(AudioClip clip, float delay, float volume = 1f, float pitch = 1f)
        {
            var source = GetNextUIAudioSource();
        ...
        public void StartLoop(out int loopId, AudioClip clip, Vector3 position, bool spatialize = true, float volume = 1f, float pitch = 1f, float duration = Mathf.Infinity)
        {
            ...
            _runtimeComponent.StartCoroutine(C_PlayLoop(source, volume, duration));
            loopId = _loopAudioSourceIndex;
        }
