...
{
    [NestedObjectPath(MenuName = "Idle State")]
    public sealed class CharacterIdleState : CharacterMovementState
    {
        ...
        public override void UpdateLogic()
        {
            ...
            if ((Input.RawMovementInput.sqrMagnitude > 0.1f || Motor.Velocity.GetHorizontal().sqrMagnitude > 0.01f)
