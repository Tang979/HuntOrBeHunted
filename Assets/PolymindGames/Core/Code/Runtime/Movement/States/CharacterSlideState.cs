...
{
    [NestedObjectPath(MenuName = "Slide State")]
    public sealed class CharacterSlideState : CharacterMovementState
    {
        [SerializeField]
        ...
        private AudioData _slideAudio = AudioData.Default;
        ...
        private int _slideAudioLoopId = AudioManager.NULL_LOOP_ID;
        ...
        public override void OnEnter(MovementStateType prevStateType)
        {
            ...
            _slideAudioLoopId = Character.AudioPlayer.StartLoop(_slideAudio.Clip, BodyPoint.Feet, _slideAudio.Volume, 1f, _slideAudioDuration);
        }

        public override void OnExit()
        {
            Character.AudioPlayer.StopLoop(ref _slideAudioLoopId);
        }
        ...
        public override void UpdateLogic()
        {
            ...
            if (_jumpInputPressed && _slideStartTime + 0.2f < Time.time)
        ...
        public override Vector3 UpdateVelocity(Vector3 currentVelocity, float deltaTime)
        {
            ...
            targetVelocity = Vector3.ClampMagnitude(Input.MovementInput * _inputFactor + targetVelocity, previousMagnitude);
