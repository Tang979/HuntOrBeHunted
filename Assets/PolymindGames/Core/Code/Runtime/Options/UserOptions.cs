...
namespace PolymindGames
{
    ...
    public abstract class UserOptions : ScriptableObject
    {
        ...
        protected const string OPTIONS_MENU_PATH = "Polymind Games/Options/";

        /// <summary>
        /// Gets or sets a value indicating whether the options have been changed.
        /// </summary>
        ...
        /// <summary>
        /// Initializes the options by finding all option fields and subscribing to their change events.
        /// </summary>
    ...
    /// <summary>
    /// Base class for managing user options stored as ScriptableObjects, with support for a specific type of options.
    /// </summary>
