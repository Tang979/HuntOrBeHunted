...
namespace PolymindGames.SaveSystem
{
    ...
    public struct SerializedRigidbodyData
    {
        ...
        public static SerializedRigidbodyData[] ExtractFromRigidbodies(Rigidbody[] rigidbodies)
        {
        ...
        public static void ApplyToRigidbodies(Rigidbody[] rigidbodies, SerializedRigidbodyData[] data)
        {
            if (data == null)
                return;
