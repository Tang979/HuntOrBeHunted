...
namespace PolymindGames.SaveSystem
{
    ...
    public struct SerializedTransformData
    {
        ...
        public static SerializedTransformData[] ExtractFromTransforms(Transform[] transforms)
        {
        ...
        public static void ApplyToTransforms(Transform[] transforms, SerializedTransformData[] data)
        {
            if (data == null)
                return;
        ...
        public static void ApplyToTransforms(Transform[] transforms, SerializedTransformData[] data, SaveFlags flags)
        {
            if (data == null)
                return;
