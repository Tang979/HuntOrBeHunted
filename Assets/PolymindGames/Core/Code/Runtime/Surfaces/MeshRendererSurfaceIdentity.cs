...
namespace PolymindGames.SurfaceSystem
{
    ...
    public sealed class MeshRendererSurfaceIdentity : SurfaceIdentity<MeshCollider>
    {
        ...
        protected override SurfaceDefinition GetSurfaceFromHit(MeshCollider col, ref RaycastHit hit)
        {
        ...
        protected override void OnValidate()
        {
            ...
            {
	            var subMeshCount = mesh.sharedMaterials.Length;
