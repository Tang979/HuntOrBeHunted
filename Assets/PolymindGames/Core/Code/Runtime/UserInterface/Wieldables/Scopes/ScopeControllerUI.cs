...
namespace PolymindGames.UserInterface
{
    ...
    public sealed class ScopeControllerUI : CharacterUIBehaviour
    {
        ...
        private void OnEquipStart(IWieldable wieldable)
        {
            ...
            {
                _firearm = firearm;
                _firearm.AddChangedListener(AttachmentType.Sight, OnSightChanged);
                OnSightChanged();
            }
        }
        ...
        private void OnHolsterStart(IWieldable wieldable)
        {
            if (_firearm != null)
            {
                _firearm.RemoveChangedListener(AttachmentType.Sight, OnSightChanged);
                _firearm = null;
                OnSightChanged();
            }
        }
        ...
        private void OnSightChanged()
        {
            ...
            if (_firearm != null && _firearm.Sight is IScopeHandler scopeHandler)
            {
