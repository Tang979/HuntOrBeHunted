...
{
    public interface IWieldableControllerCC : ICharacterComponent
    {
        /// <summary>
        ...
        /// <param name="holsterSpeedMod">How fast should the active wieldable be holstered</param>
        ...
        bool TryEquipWieldable(IWieldable wieldable, float holsterSpeedMod = 1f, UnityAction equipCallback = null);
        ...
        /// <param name="holsterSpeedMod"></param>
        /// <returns> True if successfully popped.</returns>
        bool TryHolsterWieldable(IWieldable wieldable, float holsterSpeedMod = 1f);
        ...
        IWieldable RegisterWieldable(IWieldable wieldable);
        
        /// <summary>
        /// Unregisters a wieldable from the available pool.
        /// </summary>
        ...
        void UnregisterWieldable(IWieldable wieldable, bool destroy = false);
    }
