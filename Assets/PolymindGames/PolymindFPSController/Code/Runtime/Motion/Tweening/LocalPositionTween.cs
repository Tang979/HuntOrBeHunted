...
namespace PolymindGames.ProceduralMotion
{
  public static partial class TweenExtensions
  {
    public static Tween<Vector3> TweenLocalPosition(this Transform self, Vector3 to, float duration) =>
      Tween<Vector3, Transform>.Add<LocalPositionTween>(self).SetTargetValue(to, duration);

    public static Tween<Vector3> TweenLocalPosition(this GameObject self, Vector3 to, float duration) =>
      Tween<Vector3, Transform>.Add<LocalPositionTween>(self.transform).SetTargetValue(to, duration);
    }
    ...
    public sealed class LocalPositionTween : Tween<Vector3, Transform> 
    {
        /// <summary>
        /// Overriden method which is called when the tween starts and should
        /// return the tween's initial value.
        /// </summary>
        protected override Vector3 GetDefaultFrom() => component.localPosition;
        ...
        protected override void OnUpdate (float easedTime)
        {
            ...
            component.localPosition = currentValue;
        }
    }
}