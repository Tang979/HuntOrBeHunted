...
namespace PolymindGames.ProceduralMotion
{
    public static partial class TweenExtensions
  {
    public static Tween<Vector3> TweenLocalScale(this Transform self, Vector3 to, float duration) =>
      Tween<Vector3, Transform>.Add<LocalScaleTween>(self).SetTargetValue(to, duration);

    public static Tween<Vector3> TweenLocalScale(this GameObject self, Vector3 to, float duration) =>
      Tween<Vector3, Transform>.Add<LocalScaleTween>(self.transform).SetTargetValue(to, duration);
  }
    ...
    public sealed class LocalScaleTween : Tween<Vector3, Transform>
    {
        /// <summary>
        /// Overriden method which is called when the tween starts and should
        /// return the tween's initial value.
        /// </summary>
        protected override Vector3 GetDefaultFrom() => component.localScale;
        ...
        protected override void OnUpdate (float easedTime)
        {
            ...
            component.localScale = currentValue;
        }
    }
}