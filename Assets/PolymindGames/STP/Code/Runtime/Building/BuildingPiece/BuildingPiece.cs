...
namespace PolymindGames.BuildingSystem
{
    ...
    public abstract class BuildingPiece : MonoBehaviour
    {
        ...
        [SerializeField, DisabledInLineEditor, BeginGroup, EndGroup]
        ...
        public IConstructable Constructable => _constructable;
        ...
        {
            ExcludeCollisions(PhysicsUtils.AllLayers);
        ...
        {
            for (int i = 0; i < _colliders.Length; i++)
                _colliders[i].excludeLayers = mask;
        }
        ...
        protected virtual void Awake()
        {
            ...
            _constructable.Constructed += () => SetState(BuildingPieceState.Constructed);
        }
