...
namespace PolymindGames.BuildingSystem
{
    ...
    public sealed class SleepingBag : MonoBehaviour, ISleepingPlace
    {
        ...
        public Vector3 SleepRotation => (Quaternion.LookRotation(transform.up, transform.right) * Quaternion.Euler(_sleepRotationOffset)).eulerAngles;
        ...
        private void Reset() => gameObject.AddComponent<SimpleInteractable>();
