...
namespace UnityEngine
{
    ...
    /// </summary>
    [Serializable]
    public sealed class SerializedScene : ISerializationCallbackReceiver
    {
#if UNITY_EDITOR
        [SerializeField]
        ...
        void ISerializationCallbackReceiver.OnBeforeSerialize() => UpdateProperties();
        ...
        /// </summary>
        public bool CanBeLoaded => BuildIndex != SceneSerializationUtility.InvalidSceneIndex;
    }
}