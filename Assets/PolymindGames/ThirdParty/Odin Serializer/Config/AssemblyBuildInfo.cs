...
namespace PolymindGames.OdinSerializer.Utilities.Editor
{
    using System;
    using System.Linq;
    using UnityEditor;
    ...
    public sealed class AOTImportSettingsConfig : OdinSerializationBuiltSettings
    {
    ...
    public sealed class JITImportSettingsConfig : OdinSerializationBuiltSettings
    {
        public override void Apply()
        {
    ...
    public sealed class EditorOnlyImportSettingsConfig : OdinSerializationBuiltSettings
    {
        public override void Apply()
        {
            OdinAssemblyImportSettingsUtility.ApplyImportSettings(NoEditorSerializationMeta, AssemblyImportSettings.Exclude);
